#define MyAppName "Insight Bridge Web"
#define MyAppVersion "1.0"
#define MyAppPublisher "DPSI Inc."
#define MyAppURL "https://www.dpsi.com/"

#define OutputEXE "InsightBridgeWeb"
#define desFolder "Web"
...
; Using default icons instead of custom ones
; SetupIconFile=.\assets\images\insightbridge.ico
; UninstallDisplayIcon={uninstallexe}
Compression=lzma
SolidCompression=yes
; WizardImageFile=.\assets\images\InsightBridgeInstallWiz.bmp
DirExistsWarning=no
ArchitecturesInstallIn64BitMode=x64

[Messages]
BeveledLabel=DPSI Inc
...
[Files]
Source: "..\frontend\build\*"; DestDir: "{app}\{#desFolder}"; Flags: ignoreversion recursesubdirs createallsubdirs

[Icons]
Name: "{userdesktop}\{#MyAppName} - Web"; Filename: "http://localhost:3000/"; Tasks: desktopicon

[Registry]
Root: HKLM; Subkey: "Software\DPSI\Insight Bridge\{#desFolder}"; ValueType: string; ValueName: "InstallPath"; ValueData: "{app}";
Root: HKLM; Subkey: "Software\DPSI\Insight Bridge\"; ValueType: string; ValueName: "InstallPath"; ValueData: "{app}"; Flags: createvalueifdoesntexist

[Tasks]
Name: "desktopicon"; Description: "Create a desktop shortcut to open Insight Bridge Web"; GroupDescription: "Additional tasks"
...
const
  ...
  IISApplicationPoolName = 'InsightBridgeWeb';
  IISSiteName = 'Insight Bridge Web';
...
begin
 if RegQueryStringValue(HKLM, 'Software\DPSI\Insight Bridge\','InstallPath', installpath) then
 begin
    folder := installpath;    
 end else begin
