...
namespace InsightBridge.Infrastructure.Migrations
{
    ...
    [Migration("20250515120547_InitialIdentity")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("InsightBridge.Domain.Models.ApplicationUser", b =>
                {
            ...
            modelBuilder.Entity("InsightBridge.Domain.Models.DatabaseConnection", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("InsightBridge.Domain.Models.Report", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("InsightBridge.Domain.Models.UserPermission", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("InsightBridge.Domain.Models.UserPermission", b =>
                {
                    ...
                    b.HasOne("InsightBridge.Domain.Models.ApplicationUser", "User")
                        .WithMany()
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("InsightBridge.Domain.Models.ApplicationUser", null)
                        .WithMany()
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
